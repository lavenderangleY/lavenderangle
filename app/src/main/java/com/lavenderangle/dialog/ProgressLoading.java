package com.lavenderangle.dialog;
...
public class ProgressLoading extends Dialog{
    ...
    public ProgressLoading(Context context) {
        ...
        view = getLayoutInflater().inflate(R.layout.la_dialog_progress, null);
    ...
    public void setSpinnerType() {
        ivProgressSpinner.setImageResource(R.drawable.la_round_spinner);
